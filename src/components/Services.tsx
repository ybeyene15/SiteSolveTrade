import { Network, Telescope, Compass, Gauge } from 'lucide-react';

const services = [
  {
    icon: Network,
    title: 'Strategic mapping',
    description: 'We build digital platforms that transform raw potential into powerful online experiences.'
  },
  {
    icon: Telescope,
    title: 'Technical evolution',
    description: 'Our strategic approach ensures every pixel serves your business goals with surgical precision.'
  },
  {
    icon: Compass,
    title: 'Design architecture',
    description: 'Intelligent design frameworks that translate complex business requirements into seamless digital ecosystems.'
  },
  {
    icon: Gauge,
    title: 'Performance optimization',
    description: 'Continuous refinement strategies that keep your digital presence sharp and competitive.'
  }
];
